...
export default function DashboardPage() {
  ...
  const [notifications] = useState([
    { id: '1', title: 'Nuevo proyecto creado', read: false },
    { id: '2', title: 'IA genera nuevas ideas', read: false },
    { id: '3', title: 'Recordatorio de entrega', read: true },
    { id: '4', title: 'Colaborador añadido', read: true }
  ]);
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex items-center space-x-3">
              <div className="relative">
                <Button 
                  ...
                  className="border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 relative"
                >
                  <Bell className="w-4 h-4" />
                  {unreadNotificationCount > 0 && (
                    <span className="absolute -top-1 -right-1 bg-[#cb4335] text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold">
        ...
        <main className="flex-1 overflow-auto p-6 bg-gray-50 dark:bg-[#17202a]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <Card 
              className="bg-white dark:bg-[#1a252f] border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-200 cursor-pointer hover:border-[#cb4335] group"
              onClick={() => {
                addToast({
                  type: 'info',
                  title: 'Navegando a Proyectos',
                  message: 'Cargando vista de todos los proyectos...',
                  duration: 3000
                });
              ...
              <CardHeader className="pb-3">
                <CardTitle className="text-gray-900 dark:text-white text-lg flex items-center justify-between">
                  <div className="flex items-center">
                    <Briefcase className="w-5 h-5 mr-2 text-[#cb4335] group-hover:scale-110 transition-transform" />
                    Proyectos Totales
                  </div>
                  <ExternalLink className="w-4 h-4 text-gray-400 group-hover:text-[#cb4335] transition-colors" />
                </CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mt-3">
                  <div 
                    className="bg-gradient-to-r from-[#cb4335] to-[#a93226] h-2 rounded-full transition-all duration-300"
            ...
            <Card 
              ...
              onClick={() => {
                addToast({
                  ...
                  message: 'Mostrando proyectos completados...',
                  duration: 3000
                });
            ...
            >
              <CardHeader className="pb-3">
                <CardTitle className="text-gray-900 dark:text-white text-lg flex items-center justify-between">
                  <div className="flex items-center">
                    <Award className="w-5 h-5 mr-2 text-[#cb4335] group-hover:scale-110 transition-transform" />
            ...
            >
              <CardHeader className="pb-3">
                <CardTitle className="text-gray-900 dark:text-white text-lg flex items-center justify-between">
                  <div className="flex items-center">
                    <TrendingUp className="w-5 h-5 mr-2 text-[#cb4335] group-hover:scale-110 transition-transform" />
                    Progreso Semanal
                  </div>
                  <ExternalLink className="w-4 h-4 text-gray-400 group-hover:text-[#cb4335] transition-colors" />
                </CardTitle>
            ...
            <Card 
              className="bg-white dark:bg-[#1a252f] border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-200 cursor-pointer hover:border-[#cb4335] group"
              onClick={() => router.push('/projects?view=pages')}
            >
              <CardHeader className="pb-3">
                <CardTitle className="text-gray-900 dark:text-white text-lg flex items-center justify-between">
                  <div className="flex items-center">
                    <BookOpen className="w-5 h-5 mr-2 text-[#cb4335] group-hover:scale-110 transition-transform" />
                    Total de Páginas
                  </div>
                  <ExternalLink className="w-4 h-4 text-gray-400 group-hover:text-[#cb4335] transition-colors" />
                </CardTitle>
            ...
            >
              <CardHeader className="pb-3">
                <CardTitle className="text-gray-900 dark:text-white text-lg flex items-center justify-between">
                  <div className="flex items-center">
                    <Brain className="w-5 h-5 mr-2 text-[#cb4335] group-hover:scale-110 transition-transform" />
                    Ideas Generadas
                  </div>
                  <ExternalLink className="w-4 h-4 text-gray-400 group-hover:text-[#cb4335] transition-colors" />
                </CardTitle>
            ...
            >
              <CardHeader className="pb-3">
                <CardTitle className="text-gray-900 dark:text-white text-lg flex items-center justify-between">
                  <div className="flex items-center">
                    <Clock3 className="w-5 h-5 mr-2 text-[#cb4335] group-hover:scale-110 transition-transform" />
                    En Progreso
                  </div>
                  <ExternalLink className="w-4 h-4 text-gray-400 group-hover:text-[#cb4335] transition-colors" />
                </CardTitle>
