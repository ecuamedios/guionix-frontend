...
check_endpoint "/studio?mode=new" "200" "Wizard principal"
check_endpoint "/studio?mode=new&phase=1" "200" "Fase 1: Generación de Ideas"
check_endpoint "/studio?mode=new&phase=2" "200" "Fase 2: Desarrollo de Estructura"
check_endpoint "/studio?mode=new&phase=3" "200" "Fase 3: Escritura Profesional"
check_endpoint "/studio?mode=new&phase=4" "200" "Fase 4: Control de Calidad"
