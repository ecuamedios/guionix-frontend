        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-white">GUIONIX Studio</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <Card key={phase.id} className={`relative overflow-hidden transition-all duration-300 ${
                  ...
                  {index < phases.length - 1 && (
                    <div className="absolute -right-3 top-1/2 transform -translate-y-1/2 z-10">
                      <div className="w-6 h-6 bg-gray-700 rounded-full border-4 border-gray-900 flex items-center justify-center">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm text-white">{Math.round(getPhaseProgress())}%</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              ...
              <CardTitle className="text-white">Formato Profesional</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-300">
                Resultado final en formato estándar de la industria, listo para producción.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400 mt-4 text-sm">
            El proceso completo toma aproximadamente 45-70 minutos
          </p>
        </div>
      </div>
    </div>
